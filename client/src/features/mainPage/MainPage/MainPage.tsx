  ...
  return (
    <div>
      ...
      <div className="mainpage_desc">
        <p>
          Мы создаем уникальное образовательное пространство, где каждый сотрудник может раскрыть
          свой потенциал, обрести новые знания и навыки, необходимые для уверенного соперничества в
          быстро меняющемся мире финансов.
        </p>
      </div>
